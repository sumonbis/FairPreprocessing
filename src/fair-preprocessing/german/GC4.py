...
# y2_grid_search_cv = GridSearchCV(svc_clf, param_grid=y2_params)
# y2_grid_search_cv.fit(y2_X_train, y2_y_train)
# y2_model = y2_grid_search_cv.best_estimator_
y2_mdl = SVC(random_state=42).fit(y2_X_train, y2_y_train)

# y1_grid_search_cv = GridSearchCV(svc_clf, param_grid=y1_params)
# y1_grid_search_cv.fit(y1_X_train, y1_y_train)
# y1_model = y1_grid_search_cv.best_estimator_
